...
public:
	...
	void turnLeft()
	{
		car_body.model_matrix_ = glm::translate(car_body.center_)*glm::rotate(glm::mat4(), glm::radians(turn_coeff_), glm::vec3(0, 0, 1)) * glm::translate(-car_body.center_) * car_body.model_matrix_;
		//Model = glm::translate(tri_center)*glm::rotate(glm::mat4(), glm::radians(1.0f), glm::vec3(0, 0, 1)) * glm::translate(-car_center) * Model;
		...
		car_body.rotateCenteredZAxis(1.0);
